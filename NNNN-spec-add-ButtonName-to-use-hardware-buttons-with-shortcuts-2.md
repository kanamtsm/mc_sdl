...
* ButtonName notification sequence when "MOVE_FOCUS_DOWN" is selected (NAV_LIST)
  ...
  ![pic4](../assets/proposals/NNNN-spec-add-ButtonName-to-use-hardware-buttons-with-shortcuts/NNNN-spec-add-ButtonName-to-use-hardware-buttons-with-shortcuts_04.PNG)
